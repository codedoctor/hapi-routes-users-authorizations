...
(function() {
  module.exports = {
    ...
    couldNotFindMethodsUsers: "Could not find 'methods.users' in 'hapi-identity-store' plugin.",
    couldNotFindMethodsOauthAuth: "Could not find 'methods.oauthAuth' in 'hapi-identity-store' plugin.",
